...
export const getMoreProperties =
  ...
  (id) =>
  async (dispatch) => {
    let getProperty = await getModifyPropertyService(id);
    return getProperty;
  };
