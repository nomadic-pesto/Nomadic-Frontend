export const constants = {
  ...
  SUB_DESTINATION_TYPES: [
    ...
    { destination: "Hills", name: "Shillong", icon: "fa-area-chart" },
    { destination: "Hills", name: "Mussoorie", icon: "fa-area-chart" },
    { destination: "Hills", name: "Auli", icon: "fa-area-chart" },
    { destination: "Hills", name: "Nainital", icon: "fa-area-chart" },
    { destination: "Hills", name: "Ooty", icon: "fa-area-chart" },
    { destination: "Hills", name: "Darjeeling", icon: "fa-area-chart" },
    { destination: "Hills", name: "Gangtok", icon: "fa-area-chart" },
    {
      destination: "Hills",
      name: "Mahabaleshwar",
      icon: "fa-area-chart",
    },
    { destination: "Hills", name: "Coorg", icon: "fa-area-chart" },
    { destination: "Hills", name: "Chikmagalur", icon: "fa-area-chart" },
    { destination: "Hills", name: "Munnar", icon: "fa-area-chart" },
    { destination: "Hills", name: "Kodaikanal", icon: "fa-area-chart" },
    { destination: "Hills", name: "Wayanad", icon: "fa-area-chart" },
