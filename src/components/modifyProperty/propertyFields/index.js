                                                ...
                                                >
                                                    ...
                                                    >
                                                        <CheckboxComponent
                                                            ...
                                                            name="amenities"
                                                            form={form}
                                                            onClick={() => {if (!form.values["amenities"].includes("Wifi")) {
                                                                    let tempValues =[...form.values["amenities"],"Wifi",];
                                                                    return form.setFieldValue("amenities",tempValues);
                                                                } else {
                                                                    let tempValues =[...form.values["amenities"],];tempValues.splice(tempValues.findIndex((val) =>val ==="Wifi"),1);
                                                                    return form.setFieldValue("amenities",tempValues);
                                                                }
                                                            }}
                                                        />
                                                    ...
                                                    <Grid
                                                      ...
                                                      <Grid
                                                        ...
                                                        <CheckboxComponent
                                                          ...
                                                          onClick={() =>
                                                            {
                                                              if(!form.values["amenities"].includes('Heating')){
                                                                let tempValues = [...form.values["amenities"],"Heating"]
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                              else{
                                                                
                                                                let tempValues = [...form.values["amenities"]]
                                                                tempValues.splice(tempValues.findIndex((val)=>val==='Heating'),1)
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                            }
                                                          }
                                                      ...
                                                      <Grid
                                                        ...
                                                        <CheckboxComponent
                                                          ...
                                                          onClick={() =>
                                                            {
                                                              if(!form.values["amenities"].includes('Washing Machine')){
                                                                let tempValues = [...form.values["amenities"],"Washing Machine"]
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                              else{
                                                                
                                                                let tempValues = [...form.values["amenities"]]
                                                                tempValues.splice(tempValues.findIndex((val)=>val==='Washing Machine'),1)
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                            }
                                                          }
                                                      ...
                                                      <Grid
                                                        ...
                                                        <CheckboxComponent
                                                          ...
                                                          onClick={() =>
                                                            {
                                                              if(!form.values["amenities"].includes('TV')){
                                                                let tempValues = [...form.values["amenities"],"TV"]
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                              else{
                                                                
                                                                let tempValues = [...form.values["amenities"]]
                                                                tempValues.splice(tempValues.findIndex((val)=>val==='TV'),1)
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                            }
                                                          }
                                                      ...
                                                      <Grid
                                                        ...
                                                        <CheckboxComponent
                                                          ...
                                                          onClick={() =>
                                                            {
                                                              if(!form.values["amenities"].includes('Furniture')){
                                                                let tempValues = [...form.values["amenities"],"Furniture"]
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                              else{
                                                                
                                                                let tempValues = [...form.values["amenities"]]
                                                                tempValues.splice(tempValues.findIndex((val)=>val==='Furniture'),1)
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                            }
                                                          }
                                                      ...
                                                      <Grid
                                                        ...
                                                        <CheckboxComponent
                                                          ...
                                                          onClick={() =>
                                                            {
                                                              if(!form.values["amenities"].includes('Security Camera')){
                                                                let tempValues = [...form.values["amenities"],"Security Camera"]
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                              else{
                                                                
                                                                let tempValues = [...form.values["amenities"]]
                                                                tempValues.splice(tempValues.findIndex((val)=>val==='Security Camera'),1)
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                            }
                                                          }
                                                      ...
                                                      <Grid
                                                        ...
                                                        <CheckboxComponent
                                                          ...
                                                          onClick={() =>
                                                            {
                                                              if(!form.values["amenities"].includes('Dedicated workspace')){
                                                                let tempValues = [...form.values["amenities"],"Dedicated workspace"]
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                              else{
                                                                
                                                                let tempValues = [...form.values["amenities"]]
                                                                tempValues.splice(tempValues.findIndex((val)=>val==='Dedicated workspace'),1)
                                                                return form.setFieldValue("amenities", tempValues)
                                                              }
                                                            }
                                                          }
